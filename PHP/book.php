...
<body>
    <form action="" class="form-data">
        ...
        <label for="id">ID of book</label><br>
        ...
        <label for="typebooks">Type of book</label>
        <select name="txt-typebook" id="typebook" class="form-control">
            <option value="0">------Select type of book-------</option>
            <?php
                $sql="SELECT ID,Name FROM typebooks";
                $result=$con->query($sql);
        ...
        <label for="des">Description about book</label><br>
